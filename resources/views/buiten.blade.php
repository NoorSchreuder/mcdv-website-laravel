                ...
                <div class="row">
                    <div class="col-lg-5 offset-lg-1">
                        <ul class="ap-services">
                            <li><i class="icon_check"></i> Parkeerplek</li>
                            <li><i class="icon_check"></i> Buiten terras</li>
                            <li><i class="icon_check"></i> BBQ</li>
                            <li><i class="icon_check"></i> Zwembad</li>
                            <li><i class="icon_check"></i> Bedjes</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="responsive">
                        <div class="gallery">
                            <a target="_blank" href="img/outside/buitened.jpg">
                                <img src="img/outside/buitened.jpg" alt="Badeend in zwembad" width="600" height="400">
                            </a>
                            <div class="desc"></div>
                        </div>
                    </div>

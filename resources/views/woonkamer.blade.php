                ...
                <li class="active"><a href="./contact.html">Contact</a>
                    <ul class="dropdown">
                        ...
                        <li><a href="./how-to-get-there.html">Routebeschrijving</a></li>
                           <!-- <li class="active"><a href="./about-us.html">Over ons</a></li> -->
                    </ul>
                </li>
            </ul>
        </nav>
                    ...
                    <div class="responsive">
                        <div class="gallery">
                            <a target="_blank" href="img/huisje/binnenkomst.jpg">
                                <img src="img/huisje/binnenkomst.jpg" alt="Badeend in zwembad" width="600" height="400">
                            </a>
                            <div class="desc"></div>
                        </div>
                    </div>
                    ...
                    <div class="responsive">
                        <div class="gallery">
                            <a target="_blank" href="img/kitchen/nis_keuken.jpg">
                                <img src="img/kitchen/nis_keuken.jpg" alt="Northern Lights" width="600" height="400">
                            </a>
                            <div class="desc"></div>
                        </div>
                    </div>
                    <div class="responsive">
                        <div class="gallery">
                            <a target="_blank" href="img/kitchen/pannen_keuken.jpg">
                                <img src="img/kitchen/pannen_keuken.jpg" alt="Northern Lights" width="600" height="400">
                            </a>
                            <div class="desc"></div>
                        </div>
                    </div>

...
<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <nav class="mainmenu mobile-menu">
            <ul>
                ...
                <li><a href="./what-to-do.html">Wat te doen </a>
                    <ul class="dropdown">
                        <li><a href="./where-to-go.html">Uitstapjes</a></li>
                ...
                <li class="active"><a href="./contact.html">Contact</a>
                    <ul class="dropdown">
                        <li><a href="./availability.html">Beschikbaarheid</a></li>
        ...
        <ul class="top-widget">
            <li><i class="fa fa-phone"></i> (06) 55 01 24 90</li>

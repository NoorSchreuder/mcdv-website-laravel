    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <nav class="mainmenu mobile-menu">
            <ul>
                ...
                <li class="active"><a href="./apartment.html">Het appartement </a>
                    <ul class="dropdown">
                        <li><a href="./apartment-details.html">Foto's</a></li>
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="./apartment.html">Appartement </a>
                                        <ul class="dropdown">
                                            <li><a href="./apartment-details.html">Foto's</a></li>
                                            <li class="active"><a href="./ .html"> </a></li>
                                            <li><a href="./more-information.html">Meer informatie</a></li>

                                        </ul>
                                    </li>
                                    <li><a href="./what-to-do.html">Wat te doen </a>
                                        <ul class="dropdown">
                                            <li><a href="./where-to-go.html">In de omgeving</a></li>
                                            <li><a href="./where-to-eat.html">Lekker eten & drinken</a></li>
                                            <li><a href="./where-to-rent.html">Activiteiten</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="./contact.html">Contact</a>
                                        <ul class="dropdown">
                        ...
                        <div class="responsive">
                            <div class="gallery">
                                <a target="_blank" href="img/huisje/binnenkomsttafel.jpg">
                                    <img src="img/huisje/binnenkomsttafel.jpg" alt="Binnenkomst vakantiehuis"
                        ...
                        <div class="responsive">
                            <div class="gallery">
                                <a target="_blank" href="img/kitchen/keuken.jpg">
                                    <img src="img/kitchen/keuken.jpg" alt="Badeend in zwembad" width="600" height="400">
                                </a>
                                <div class="desc"></div>
                            </div>
                        </div>
